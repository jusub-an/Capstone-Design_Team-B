...
const MEASURE_LABELS = {
  shoulder:            { label: '어깨너비',   unit: 'cm' },
  chest:               { label: '가슴너비',   unit: 'cm' },
  waist:               { label: '허리너비',   unit: 'cm' },
  hip:                 { label: '골반너비',   unit: 'cm' },
  thigh:               { label: '허벅지너비', unit: 'cm' },
  chest_circumference: { label: '가슴둘레',   unit: 'cm' },
  waist_circumference: { label: '허리둘레',   unit: 'cm' },
  hip_circumference:   { label: '골반둘레',   unit: 'cm' },
  thigh_circumference: { label: '허벅지둘레', unit: 'cm' },
  sleeve:              { label: '팔길이', unit: 'cm' },
  arm_width:           { label: '팔너비(이두)', unit: 'cm' },
  inseam:              { label: '인심',        unit: 'cm' },
  neck:                { label: '목둘레',     unit: 'cm' },
  top_length:          { label: '상체길이',   unit: 'cm' },
  bottom_length:       { label: '하반신길이', unit: 'cm' },
  rise:                { label: '샅길이',   unit: 'cm' },
  hem:                 { label: '발목너비',   unit: 'cm' },
