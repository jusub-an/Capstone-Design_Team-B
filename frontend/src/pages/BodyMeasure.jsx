              ...
              <div className="mg-section">
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: '6px' }}>
                  {[
                    ...
                    '여성 유저의 경우 머리카락을 올려 묶어 얼굴과 목선이 잘 드러나도록 해주세요.',
          ...
          <div style={cardStyle}>
            ...
            {isResultExpanded && (
              <>
                ...
                {(() => {
                  const CLOTHING_MAP = {
                    top_length: { category: 'top', field: '총장', color: '#00FF00' },
                    shoulder:   { category: 'top', field: '어깨단면', color: '#FFA500' },
                    chest:      { category: 'top', field: '가슴단면', color: '#C800C8' },
                    chest_circumference: { category: 'top', field: '-', color: '#C800C8' },
                    waist:      { category: 'top', field: '허리단면', color: '#FF0000' },
                    waist_circumference: { category: 'top', field: '-', color: '#FF0000' },
                    sleeve:     { category: 'top', field: '소매길이', color: '#00BFFF' },
                    arm_width:  { category: 'top', field: '소매단면', color: '#FF4500' },
                    left_arm_angle:  { category: 'top', field: '-', color: '#B39DDB' },
                    right_arm_angle:  { category: 'top', field: '-', color: '#B39DDB' },
                    bottom_length: { category: 'bottom', field: '총장', color: '#FFFF00' },
                    hip:        { category: 'bottom', field: '엉덩이단면', color: '#FFA500' },
                    hip_circumference: { category: 'bottom', field: '-', color: '#FFA500' },
                    thigh:      { category: 'bottom', field: '허벅지단면', color: '#00FFFF' },
                    thigh_circumference: { category: 'bottom', field: '-', color: '#00FFFF' },
                    rise:       { category: 'bottom', field: '밑위길이', color: '#FF69B4' },
                    hem:        { category: 'bottom', field: '밑단단면', color: '#32CD32' },
                    leg_angle:  { category: 'bottom', field: '-', color: '#9FA8DA' },
                  };
